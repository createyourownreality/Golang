...
type CustomerService interface {
	...
	GetCustomerById(ctx context.Context, id int) (*dto.CustomerResponse, error)
...
func (s DefaultCustomerService) GetCustomerById(ctx context.Context, id int) (*dto.CustomerResponse, error) {
